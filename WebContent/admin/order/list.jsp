	...
	<HEAD>
		...
		<script type="text/javascript">
			$(function(){
				//弹出层插件调用
				new PopupLayer({
					trigger:".clickedElement",//出发点 点击谁弹出div
					...
					<tr>
						<td class="ta_01" align="center" bgColor="#f5fafe">
							<table cellspacing="0" cellpadding="1" rules="all"
								...
								<c:forEach items="${orders }" var="order" varStatus="vr">
        ...
        <div id="showDiv" class="blk" style="display:none;">
            <div class="main">
                ...
                <div id="loading" style="padding-top:30px;text-align: center;">
                	<img alt="" src="${pageContext.request.contextPath }/img/timg.gif">
                </div>
