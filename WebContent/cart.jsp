	...
	<body>
		...
		<c:if test="${!empty cart.catItems}">
				...
				<div style="margin:0 auto; margin-top:10px;width:950px;">
					...
					<table class="table table-bordered">
						<tbody>
							...
							<c:forEach items="${cart.catItems }" var="entry">
								<tr class="active">
			...
			<div style="margin-right:130px;">
				...
				<div style="text-align:right;margin-top:10px;margin-bottom:10px;">
					<a href="javascript:void(0)" onclick="cleatrCart()" id="clear" class="clear">清空购物车</a>
		...
		<c:if test="${empty cart.catItems}">
		   <div>
			...
			<a href="${pageContext.request.contextPath }/index">购物车为空,请返回首页继续购物吧</a>
		   </div>
		</c:if>
