			...
			<div class="col-md-10">
				...
				<c:forEach items="${hotProductList }" var="hotPro">
					...
					<div class="col-md-2"
						...
						<a
							href="${pageContext.request.contextPath }/productByPid?pid=${hotPro.pid }">
						...
						<p>
							<a
								href="${pageContext.request.contextPath }/productByPid?pid=${hotPro.pid }"
								style='color: #666'>${hotPro.pname }</a>
						</p>
						<p>
		...
		<div class="container-fluid">
			...
			<div class="col-md-10">
					...
					<div class="col-md-6"
						style="text-align: center; height: 200px; padding: 0px;">
						<a
							href="${pageContext.request.contextPath }/productByPid?pid=${newPro.pid }">
					...
					<div class="col-md-2"
						...
						<p>
							<a
								href="${pageContext.request.contextPath }/productByPid?pid=${newPro.pid }"
								style='color: #666'>${newPro.pname }</a>
						</p>
						<p>
